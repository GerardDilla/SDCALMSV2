                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        if(result['Status'] == 1){
                            ...
                            $('#CertFile').val('');
                            $('#CertName').val('');
                            $('#cert_thumbnail')[0].src = base_url+'/assets/images/cert_icon.png';
                            $('#cert_lightbox').attr("href", base_url+'/assets/images/cert_icon.png');
                            ...
                            data.done(function(certdata){
                                ...
                                display_certificates(CertData,target,base_url);
        ...
        <li>\
            <div class="post-image">\
                <div class="img-thumbnail cert_thumbnail">\
                    <a class="lightbox" href="'+base_url+'personaldata/Certificates/'+result['Certificate']+''+result['Extension']+'" data-plugin-options=\{ "type":"image" }\'>\
...
function display_certificates_manager(data,target,base_url){
    ...
    $.each(data, function(index, result){
        ...
        <tr>\
            ...
            <td style="vertical-align: middle;">\
                <button class="btn btn-sm btn-default" onclick="remove_cert('+result['ID']+')" type="button">\
                    <span>Remove</span>\
                </button>\
            </td>\
        </tr>\
