...
<header class="header">
    <div class="logo-container">
        <a href="../" class="logo">
            <img src="<?php echo base_url(); ?>assets/images/logo-default.png" height="35" alt="JSOFT Admin" />
        </a>
        ...
        <div id="userbox" class="userbox">
            ...
            <div class="dropdown-menu">
                <ul class="list-unstyled">
                    <li class="divider"></li>
                    <li>
                        <a role="menuitem" tabindex="-1" href="<?php echo base_url(); ?>index.php/Main/Instructor_logout"><i class="fa fa-power-off"></i> Logout</a>
                    </li>
                    <!--
                    <li>
